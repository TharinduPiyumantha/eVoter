...
<script>
    function sendNotifications(){
        ...
        if(commentBool == false){
            ...
            alert("Comments Were Sent To The Removed Voters Successfully!");
        }
    }
</script>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Reasons For Removing Voters</h1>
                </div>
            </div>

            <br><br><br><br><br><br>
            <form class="form-horizontal" role="form" method="post" action="../view/editVotersInterface.php?electID=<?php echo $electionID ?>" enctype="multipart/form-data" onsubmit="return validateTable();">
