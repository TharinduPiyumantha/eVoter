                            ...
                            <form class="form-horizontal" id="myprofile" name="myprofile" action="" role="form" method="post" style="margin-top: 30px;margin-right: 40px;color: #ffffff;">
                                ...
                                <div class="col-sm-6 col-sm-offset-7 controls">
                                    <a href="memberManage.php">
                                        ...
                                        <a href="../controller/admin_delete_users.php?value=<?php echo $array[0]?>" onclick="return confirm('Are you sure?')" ><button type="button" name="btn-cancel" class="btn btn-default btn-primary" >
