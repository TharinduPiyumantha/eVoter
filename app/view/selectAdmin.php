...
<script type="text/JavaScript">
    function confirmChange(){
        confirm("Are you sure you want to change the Administrator? It will change your a member");
    }
</script>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Select New Admin </h1>
                </div>
            </div>
            ...
            <form class="form-horizontal" role="form" method="post" action="../controller/changeAdmin.php">

                <input type="checkbox" onClick="toggle(this)" /> Select All<br/>

                <div class="col-sm-offset-10 col-sm-2" style="margin-bottom: 10px; margin-left: 860px;">
                    <button type="submit" id="btn-signup" name="btn-signup" class="btn btn-default btn-primary" onclick="confirmChange()">
                        <i class="fa fa-hand-o-right"></i>&nbsp;Select Admin
                    </button>
                </div>
                ...
                <table id="memberTable" class="table table-striped table-bordered" cellspacing="0" width="10%">
                    ...
                    ?>
                    <tr  class='tableRow' id = <?php echo $data1[0]?> href='admin_select_admin.php?value=<?php echo $data1[0]?>' >
