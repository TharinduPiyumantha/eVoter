                        ...
                        <div class="col-md-8 col-md-offset-2" style="margin-top: 15px; margin-bottom: 20px;" >
                            <form class="form-horizontal" id="myprofile" name="myprofile" action="" role="form" method="post" style="margin-top: 30px;margin-right: 40px;color: #ffffff;">
                                ...
                                <div class="col-sm-6 col-sm-offset-7 controls">
                                    ...
                                    <a href="../controller/changeAdmin.php?value=<?php echo $array[0]?>" onclick="confirmChange()" ><button type="button" name="btn-cancel" class="btn btn-default btn-primary" >
                                            <i class="fa fa-thumbs-o-up"></i>&nbsp;Select
                                        </button></a>
                                </div>
                            </form>
                        </div>
