...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" role="form" method="post" action="../controller/addCandidates.php?electID=<?php echo $_GET["electID"];?>" onsubmit="return validateNoOfCandidates();">
